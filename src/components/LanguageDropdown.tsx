  ...
  return (
    <div className="relative">
      ...
      >
        ...
        />
        <span className="font-normal text-sm text-(--text-color) leading-[19.6px] open-sauce-sans">{selectedLang.label}</span>
          ...
          {languages.map((lang) => (
            ...
            >
              <img
                ...
                className="w-5 h-5 rounded-full object-cover"
              />
              <span className="font-normal text-sm text-(--text-color) leading-[19.6px] open-sauce-sans">{lang.label}</span>
            </button>
          ))}
        </div>
      )}
